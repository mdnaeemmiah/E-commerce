...
export default function Layout({ children }: { children: React.ReactNode }) {
    ...
    const menuItems = [
        ...
        { href: "/brandDashboard/campaigns", label: "Campaigns", icon: <FaUserCircle /> },
        { href: "/brandDashboard/qrCodes", label: "QR Codes", icon: <FaGift /> },
        { href: "/brandDashboard/analytics", label: "Analytics", icon: <FaStore /> },
        { href: "/brandDashboard/pricingPlans", label: "Pricing Plans", icon: <FaCog /> },
