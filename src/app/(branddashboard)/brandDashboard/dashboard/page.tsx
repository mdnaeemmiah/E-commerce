...
//     useEffect(() => {
//     // Assuming the API endpoint returns the stats in the same structure
//     const fetchData = async () => {
//       try {
//         const response = await baseApi.get(ENDPOINTS,); // Replace with your actual endpoint
//         (response.data); // Update the stats with fetched data
//       } catch (error) {
