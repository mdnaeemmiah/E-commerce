        ...
        <div className="flex justify-center items-center min-h-screen bg-[#707070] px-4">
            <div className="bg-white  p-8 rounded-lg shadow-md w-full max-w-lg md:pb-15">
                ...
                <div className="mt-4 text-center">
                    <h1 className="text-[#828282]">Don’t have an account ?<span className="font-semibold text-[#3E3EDF] cursor-pointer"> <Link href='/brandAuth/singup'>Sign up</Link> </span></h1>
                </div>
            </div>
        </div>
    );
