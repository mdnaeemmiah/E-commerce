    ...
    return (
        <div className="flex justify-center items-center gap-2 mt-10">
            ...
            <button
                ...
                className={`flex shadow-2xl border border-[#3E3EDF] items-center justify-center px-4 py-2 rounded-md text-gray-600 ${currentPage === 1 ? "cursor-not-allowed" : "cursor-pointer"}`}
            >
            ...
            <button
                ...
                className={`flex shadow-2xl border border-[#3E3EDF] items-center justify-center px-4 py-2 rounded-md text-gray-600 ${currentPage === totalPages ? "cursor-not-allowed" : "cursor-pointer"}`}
            >
