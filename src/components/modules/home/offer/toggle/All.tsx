...
const offers = [
  { id: 1, title: "Summer Splash Rebate", image: img1, expiration: "2025-08-31", claimUrl: "#", discount: "20%", rating: 4.5, reviews: 132 },
  { id: 2, title: "Happy Meal Deal", image: img2, expiration: "2025-01-30", claimUrl: "#", discount: "10%", rating: 4.2, reviews: 85 },
  { id: 3, title: "Gadget Master Deal", image: img1, expiration: "2025-03-15", claimUrl: "#", discount: "15%", rating: 3.8, reviews: 120 },
  { id: 4, title: "Winter Gear Sale", image: img2, expiration: "2025-11-20", claimUrl: "#", discount: "30%", rating: 4.2, reviews: 98 },
  { id: 5, title: "Smart Home Deals", image: img1, expiration: "2025-09-15", claimUrl: "#", discount: "25%", rating: 4.1, reviews: 75 },
  { id: 6, title: "Organic Wellness Bundle", image: img2, expiration: "2025-06-01", claimUrl: "#", discount: "18%", rating: 4.0, reviews: 60 },
];
        ...
        {filteredOffers.length > 0 ? (
          filteredOffers.map((offer) => (
            <SwiperSlide key={offer.id}>
              <div className="shrink-0 text-white overflow-hidden shadow-2xl p-4 rounded-xl">
