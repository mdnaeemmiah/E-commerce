...
export default function Privacy() {
    return (
        <div className='mt-10'>
            ...
            <Link href='/adminDashboard/settings/privacyEdit' className='flex justify-end'>
                <button className="flex   text-center  my-15 cursor-pointer gap-2 bg-indigo-600 text-white px-20 md:px-40 py-2 rounded-md hover:bg-indigo-700 transition ">
                    Edit
                </button>
            </Link>
        </div>
