...
//         // vendors থেকে remove
//         transactions((prev) => prev.filter((v) => v.id !== vendorId));
...
//                                             {/* Delete Button */}
//                                             <button
//                                                 className="text-red-500 cursor-pointer hover:text-red-700 hover:scale-110 transition-transform"
...
//                             <p><strong>Brand Name:</strong> {selectedTransaction.user}</p>
...
export default function BrandTable() {
    ...
    return (
        <div>
            <div className="bg-white shadow-md rounded-xl p-5 w-full mt-10">
                <div className="flex justify-between flex-col md:flex-row">
                    <h2 className="text-[22px] text-[#1F1D1D] font-semibold mb-5">Brand List</h2>
